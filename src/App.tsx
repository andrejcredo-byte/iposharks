...
function AppContent({ 
  ...
  return (
    <div className="flex h-[100dvh] pb-[env(safe-area-inset-bottom)] bg-shark-bg font-sans text-white overflow-hidden w-full fixed inset-0 select-none overscroll-none">
      <Sidebar 
      ...
      <main className="flex-1 lg:ml-64 h-full flex flex-col w-full relative overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden w-full overscroll-y-contain">
